...
describe FissionAuthService do
  describe "#matches_pattern?" do
    ...
    it "does not match partial strings without wildcard" do
      service.matches_pattern?("my-function-v2", "my-function").should be_false
      service.matches_pattern?("my-function", "my-function-v2").should be_false
    end
  end
  ...
  describe "#extract_function_info" do
    ...
    it "handles path without leading slash" do
      result = service.extract_function_info("namespace/function")
      result[:namespace].should eq("namespace")
      result[:function].should eq("function")
    end
  end
